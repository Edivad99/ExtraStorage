...
public class AdvancedStorageBlockEntity extends AbstractBaseNetworkNodeContainerBlockEntity<StorageNetworkNode>
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(AdvancedStorageBlockEntity.class);
  ...
  public AdvancedStorageBlockEntity(BlockPos pos, BlockState state, StorageBlockProvider provider) {
  ...
  @Override
  public AdvancedStorageBlockContainerMenu createMenu(final int syncId, final Inventory inventory, final Player player) {
    return new AdvancedStorageBlockContainerMenu(
