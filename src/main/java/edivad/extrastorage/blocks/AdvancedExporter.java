...
{
    private static final VoxelShape LINE_NORTH_1 = makeCuboidShape(6.0, 6.0, 0.0, 10.0, 10.0, 2.0);
    private static final VoxelShape LINE_NORTH_2 = makeCuboidShape(5.0, 5.0, 2.0, 11.0, 11.0, 4.0);
    private static final VoxelShape LINE_NORTH_3 = makeCuboidShape(3.0, 3.0, 4.0, 13.0, 13.0, 6.0);
    private static final VoxelShape LINE_NORTH = VoxelShapes.or(LINE_NORTH_1, LINE_NORTH_2, LINE_NORTH_3);
    private static final VoxelShape LINE_EAST_1 = makeCuboidShape(14.0, 6.0, 6.0, 16.0, 10.0, 10.0);
    private static final VoxelShape LINE_EAST_2 = makeCuboidShape(12.0, 5.0, 5.0, 14.0, 11.0, 11.0);
    private static final VoxelShape LINE_EAST_3 = makeCuboidShape(10.0, 3.0, 3.0, 12.0, 13.0, 13.0);
    private static final VoxelShape LINE_EAST = VoxelShapes.or(LINE_EAST_1, LINE_EAST_2, LINE_EAST_3);
    private static final VoxelShape LINE_SOUTH_1 = makeCuboidShape(6.0, 6.0, 14.0, 10.0, 10.0, 16.0);
    private static final VoxelShape LINE_SOUTH_2 = makeCuboidShape(5.0, 5.0, 12.0, 11.0, 11.0, 14.0);
    private static final VoxelShape LINE_SOUTH_3 = makeCuboidShape(3.0, 3.0, 10.0, 13.0, 13.0, 12.0);
    private static final VoxelShape LINE_SOUTH = VoxelShapes.or(LINE_SOUTH_1, LINE_SOUTH_2, LINE_SOUTH_3);
    private static final VoxelShape LINE_WEST_1 = makeCuboidShape(0.0, 6.0, 6.0, 2.0, 10.0, 10.0);
    private static final VoxelShape LINE_WEST_2 = makeCuboidShape(2.0, 5.0, 5.0, 4.0, 11.0, 11.0);
    private static final VoxelShape LINE_WEST_3 = makeCuboidShape(4.0, 3.0, 3.0, 6.0, 13.0, 13.0);
    private static final VoxelShape LINE_WEST = VoxelShapes.or(LINE_WEST_1, LINE_WEST_2, LINE_WEST_3);
    private static final VoxelShape LINE_UP_1 = makeCuboidShape(6.0, 14.0, 6.0, 10.0, 16.0, 10.0);
    private static final VoxelShape LINE_UP_2 = makeCuboidShape(5.0, 12.0, 5.0, 11.0, 14.0, 11.0);
    private static final VoxelShape LINE_UP_3 = makeCuboidShape(3.0, 10.0, 3.0, 13.0, 12.0, 13.0);
    private static final VoxelShape LINE_UP = VoxelShapes.or(LINE_UP_1, LINE_UP_2, LINE_UP_3);
    private static final VoxelShape LINE_DOWN_1 = makeCuboidShape(6.0, 0.0, 6.0, 10.0, 2.0, 10.0);
    private static final VoxelShape LINE_DOWN_2 = makeCuboidShape(5.0, 2.0, 5.0, 11.0, 4.0, 11.0);
    private static final VoxelShape LINE_DOWN_3 = makeCuboidShape(3.0, 4.0, 3.0, 13.0, 6.0, 13.0);
