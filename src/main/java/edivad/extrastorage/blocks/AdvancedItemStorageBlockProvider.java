...
public class AdvancedItemStorageBlockProvider implements StorageBlockProvider {

  private final AdvancedItemStorageVariant variant;
  private final Component displayName;

  public AdvancedItemStorageBlockProvider(AdvancedItemStorageVariant variant) {
