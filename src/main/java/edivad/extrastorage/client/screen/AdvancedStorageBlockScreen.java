...
public class AdvancedStorageBlockScreen extends StorageScreen<AdvancedStorageBlockContainerMenu> {
  ...
  public AdvancedStorageBlockScreen(AdvancedStorageBlockContainerMenu container,
    ...
    super(
        ...
        () -> (long) ((AdvancedStorageBlockEntity) container.getBlockEntity()).getItemStorageType()
            .getCapacity());
  }
}
