...
public class LockModeSideButtonWidget extends AbstractSideButtonWidget {
  ...
  public LockModeSideButtonWidget(final ClientProperty<LockMode> property) {
  ...
  private static LockMode toggle(LockMode lockMode) {
    return switch (lockMode) {
      case LockMode.NEVER -> LockMode.LOCK_UNTIL_REDSTONE_PULSE_RECEIVED;
      case LockMode.LOCK_UNTIL_REDSTONE_PULSE_RECEIVED -> LockMode.LOCK_UNTIL_CONNECTED_MACHINE_IS_EMPTY;
      case LockMode.LOCK_UNTIL_CONNECTED_MACHINE_IS_EMPTY -> LockMode.LOCK_UNTIL_ALL_OUTPUTS_ARE_RECEIVED;
      case LockMode.LOCK_UNTIL_ALL_OUTPUTS_ARE_RECEIVED -> LockMode.LOCK_UNTIL_HIGH_REDSTONE_SIGNAL;
      case LockMode.LOCK_UNTIL_HIGH_REDSTONE_SIGNAL -> LockMode.LOCK_UNTIL_LOW_REDSTONE_SIGNAL;
      case LockMode.LOCK_UNTIL_LOW_REDSTONE_SIGNAL -> LockMode.NEVER;
    };
  }
