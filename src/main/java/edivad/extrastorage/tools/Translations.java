...
public class Translations {
  ...
  public static final TranslationsAdvancement IRON_CRAFTER =
      new TranslationsAdvancement(ExtraStorage.ID, "iron_crafter");
  public static final TranslationsAdvancement ADVANCED_EXPORTER =
      new TranslationsAdvancement(ExtraStorage.ID, "advanced_exporter");
  public static final TranslationsAdvancement ADVANCED_IMPORTER =
      new TranslationsAdvancement(ExtraStorage.ID, "advanced_importer");
}
